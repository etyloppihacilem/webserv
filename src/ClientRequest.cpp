...
HttpMethod ClientRequest::parse_method( std::string const &method, size_t const &end ) {
...
static void replace_all( std::string &str, std::string const &to_find, std::string const &to_replace ) {
...
/**
  ...
  */
void ClientRequest::parse_target( std::string const &in, size_t const &pos ) {
    {
        size_t sp_protocol;
        size_t protocol;
...
/**
  ...
  */
void ClientRequest::parse_header_line( std::string const &in, size_t begin, size_t end ) {
...
void ClientRequest::init_header( std::string const &in ) {
...
/**
  ...
  */
bool ClientRequest::parse_header( std::string const &in ) {
    {
